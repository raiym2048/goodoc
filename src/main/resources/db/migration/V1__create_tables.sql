...
create table medicine (count integer, id bigserial not null, take_time_id bigint, type_id bigint, name varchar(255), primary key (id))
    ...
    ; create table users (is_active boolean, role smallint check (role between 0 and 1), id bigserial not null, email varchar(255), firstname varchar(255), lastname varchar(255), password varchar(255), primary key (id))
