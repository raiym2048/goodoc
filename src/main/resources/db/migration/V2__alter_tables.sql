 ...
 alter table if exists medicine add constraint FK6jo8tdud51x538342ecwx9rj5 foreign key (take_time_id) references take_time
    ...
    ; alter table if exists users_taken_medicine add constraint FKi8oetd8gggw0buoxnf7ysrmdl foreign key (taken_medicine_id) references medicine
    ; alter table if exists users_taken_medicine add constraint FKj5yu2xd8mbdqg7qya6i4d7r7w foreign key (user_id) references users;